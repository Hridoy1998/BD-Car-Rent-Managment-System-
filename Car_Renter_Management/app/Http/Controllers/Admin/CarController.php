...
class CarController extends Controller
{
    public function add_car(Request $request)
    {
        $request->validate([
          ...
          $res=$car->save();
          if($res){
            return back()->with('success','You Add Car successfully');
        }else{
    ...
    public function edit_car_view(Request $req)
    {
        ...
        // return $car_edit;
        return view('Admin_Pages.admin_car_edit',compact('car_edit'));
    }
    public function edit_car(Request $request)
    {
        ...
        $res=$car->save();
          if($res){
            return back()->with('success','You Car Update successfully');
        }else{
            return back()->with('fail', 'Something Went Wrong');
        }
    ...
    public function delete_car(Request $req)
    {
        ...
        $res=$car_edit;
          if($res){
            return back()->with('success','You Car Delete successfully');
        }else{
            return back()->with('fail', 'Something Went Wrong');
        }
    }
    public function search_car(Request $req)
    {
        ...
        if($BUser)
        {
            return view('Admin_Pages.search_result_cars')->with('Clist',$BUser)->with('success','Search Found');
        }
        else
        {
            $User=CarService::all();
            return view('Admin_Pages.search_result_cars')->with('Clist',$User)->with('fail','Search Found');
        }
    }
    public function single_car_details_view(Request $req)
    {
        ...
        return view('Admin_Pages.single_car_details',compact('Clist'));
    }
}
