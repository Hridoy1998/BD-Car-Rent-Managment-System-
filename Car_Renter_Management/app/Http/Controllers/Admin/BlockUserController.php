...
class BlockUserController extends Controller
{
    ...
    public function block_users_search(Request $req)
    {
        ...
        if($BUser)
        {
            return view('Admin_Pages.search_result_Block_user')->with('BUser',$BUser)->with('success','Search Found');
        }
        else
        {
            $User=BlockUser::all();
            return view('Admin_Pages.search_result_Block_user')->with('BUser',$User)->with('fail','Search Found');
        }
    }
